...
if __name__ == '__main__':
    ...
    parser.add_argument('--real', type=bool, default=False, help='use real group-labels')
    ...
    if args.test_only:
        ...
        if args.experiment != 'ERM':
            ...
            if args.real:
                ...
                balanced_loader = experiment.create_masked_balanced_dataloader(selected_feats, miscls_envs, corrcls_envs,
        ...
        if args.experiment != 'ERM':
            if args.fine_tune:
                ...
                if args.real:
                    ...
                    model = utils.get_fc(device, args.pretrained_path, num_features = d, num_classes=n, load_pretrained = False)
